...
public class GPACalc {
	public static float getGPA(final int class1, final int class2, final int class3, final int class4,final int class5 ) {
		float GPA = 0;
		...
		float class5Num = gradeToGPA(class5);
		GPA = class1Num + class2Num + class3Num + class4Num+class5Num;
		GPA = GPA/5;
		return GPA;
	}
